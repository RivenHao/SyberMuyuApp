...
import './index.scss'
import { getGalleryList, decreaseMerit } from "../../apis";
...
export default function DonateModal(props: DonateModalProps) {
  const { show, onClose, onRefresh, onCardChange } = props
  const [isFlipped, setIsFlipped] = useState(false)
  const [cardInfo, setCardInfo] = useState<any>(null)
  const [, setAllCollected] = useState(false) // 是否已集齐所有卡片
